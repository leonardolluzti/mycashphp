...
<form method="POST" action="<?php $PHP_SELF ?>" name="frmPesqRec">
<label for name="descricao">Descricao:</label>
...
$result = pg_query($conn, "SELECT * FROM receitas where descricao ilike '%".$_POST['descricao']."%' and data ilike '%".$_POST['data']."%'ORDER BY descricao;");
if (!$result) {
