...
<figure>
    ...
    <figcaption>Nova Receita</figcaption>
  </figure>
	<form method="POST" action="<?php $PHP_SELF ?>" name="frmAddRec">
...
if (isset($_POST['descricao'])){
	$result = pg_query($conn, "INSERT INTO receitas (valor, tipo, data, descricao, fixo) 
